        ...
        <div class="content-body">
            <section id="basic-vertical-layouts">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form form-vertical" id="form" action="{{ route('ikm.update', $ikm) }}"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (produk() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_produk') == $row->id || $ikm->id_produk == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (perusahaan() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_perusahaan') == $row->id || $ikm->id_perusahaan == $row->id)>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="kbli_pirt"
                                                            ...
                                                            name="kbli_pirt"
                                                            value="{{ old('kbli_pirt') ?? $ikm->kbli_pirt }}" />
                                                        @error('kbli_pirt')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="harga_jual"
                                                            ...
                                                            name="harga_jual"
                                                            value="{{ old('harga_jual') ?? $ikm->harga_jual }}" />
                                                        @error('harga_jual')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="tenaga_kerja"
                                                            ...
                                                            name="tenaga_kerja"
                                                            value="{{ old('tenaga_kerja') ?? $ikm->tenaga_kerja }}" />
                                                        @error('tenaga_kerja')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="nilai_investasi"
                                                            ...
                                                            value="{{ old('nilai_investasi') ?? $ikm->nilai_investasi }}" />
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="jumlah_produksi"
                                                            ...
                                                            value="{{ old('jumlah_produksi') ?? $ikm->jumlah_produksi }}" />
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (satuanProduksi() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_satuan_produksi') == $row->id || $ikm->id_satuan_produksi == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="nilai_produksi"
                                                            ...
                                                            name="nilai_produksi"
                                                            value="{{ old('nilai_produksi') ?? $ikm->nilai_produksi }}" />
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="nilai_bb_bp"
                                                            ...
                                                            name="nilai_bb_bp"
                                                            value="{{ old('nilai_bb_bp') ?? $ikm->nilai_bb_bp }}" />
                                                        @error('nilai_bb_bp')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="export"
                                                            ...
                                                            name="export" value="{{ old('export') ?? $ikm->export }}" />
                                                        @error('export')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan"
                                                            cols="30" rows="3">{{ old('keterangan') ?? $ikm->keterangan }}</textarea>
                                                        @error('keterangan')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
...
@push('js')
    {!! JsValidator::formRequest('App\Http\Requests\IKM\UpdateRequest', '#form') !!}
