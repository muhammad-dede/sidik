        ...
        <div class="content-body">
            <section id="basic-vertical-layouts">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form form-vertical" action="{{ route('produk.store') }}" method="POST" id="form">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select @error('id_kategori_produk') is-invalid @enderror"
                                            ...
                                            @foreach ($kategori_produk as $row)
                                                <option value="{{ $row->id }}"
                                                    {{ old('id_kategori_produk') == $row->id ? 'selected' : '' }}>
                                                    {{ $row->nama }}
                                                </option>
                                            @endforeach
                                        </select>
...
@push('js')
    {!! JsValidator::formRequest('App\Http\Requests\Produk\StoreRequest', '#form') !!}
@endpush
