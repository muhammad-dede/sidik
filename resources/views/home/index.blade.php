                        ...
                        <div class="card card-congratulations">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="#" class="btn btn-primary mt-2">Tambah Data IKM</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-developer-meetup">
                            ...
                            <div class="card-body">
                                <div class="meetup-header d-flex align-items-center">
                                    <div class="my-auto">
                                        <h4 class="card-title mb-25">{{ auth()->user()->nama }}</h4>
                                    </div>
                                </div>
                                <div class="mt-0">
...
@push('js')
    <script src="{{ asset('') }}assets/vendors/moment-js/moment-with-locales.js"></script>
    <script>
