        ...
        <div class="content-body">
            <section id="basic-vertical-layouts">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form form-vertical" id="form" action="{{ route('perusahaan.store') }}"
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (jenisKelamin() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_jenis_kelamin') == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (pendidikan() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_pendidikan') == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (jabatan() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_jabatan') == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            <option value="{{ pengaturan()->id_provinsi ?? '' }}"
                                                                selected>
                                                                {{ pengaturan()->provinsi->nama ?? '' }}
                                                            </option>
                                                        </select>
                                                        @error('id_provinsi')
                                                            <span class="invalid-feedback">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            <option value="{{ pengaturan()->id_kab_kota ?? '' }}"
                                                                selected>
                                                                {{ pengaturan()->kabKota->nama ?? '' }}
                                                            </option>
                                                        </select>
                                                        @error('id_kab_kota')
                                                            <span class="invalid-feedback">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            <option value=""></option>
                                                            @foreach (kecamatan(pengaturan()->id_kab_kota ?? null) as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_kecamatan') == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            <option value=""></option>
                                                            @foreach (kelurahan(old('id_kecamatan') ?? null) as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_kelurahan') == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select
                                                            ...
                                                            @foreach (badanUsaha() as $row)
                                                                <option value="{{ $row->id }}"
                                                                    @selected(old('id_badan_usaha') == $row->id)>
                                                                    {{ $row->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="tahun_izin"
                                                            ...
                                                            name="tahun_izin" value="{{ old('tahun_izin') }}" />
                                                        @error('tahun_izin')
                                                            <span class="invalid-feedback">
                                                                {{ $message }}
                                                            </span>
...
@push('js')
    {!! JsValidator::formRequest('App\Http\Requests\Perusahaan\StoreRequest', '#form') !!}
    {{-- Map leaflet --}}
    <script>
        $(document).ready(function() {
            var map = L.map('map').setView([{{ pengaturan()->latitude ?? -6.175 }},
                    {{ pengaturan()->longitude ?? 106.8275 }}
                ],
                13);

            L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(map);

            var marker = L.marker([{{ pengaturan()->latitude ?? -6.175 }},
                    {{ pengaturan()->longitude ?? 106.8275 }}
                ])
                .addTo(
                    map);
